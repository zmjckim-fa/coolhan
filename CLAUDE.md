...
| **2026-06-12** | **트랙9: 공학≠과학 게이트 적대적 검증 통과** | _harness_test/track9-sci/ | S1 동어반복(엔진PASS/verdict=insufficient/tautology FAIL/"입증됨" 미방출), S2 정상과학(실계산 diff+0.55,p=0.00059,셔플소멸,held-out재현,FDR — supported_by_data, 단정 없음), S3 추적성위반(provenance FAIL→insufficient). 게이트 4/4, 오탐·누락 0 |
