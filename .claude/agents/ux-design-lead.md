...
- **Work silently, report once (2026-07-19):** ⛔ Zero prose between tool calls. No screen-by-screen narration. After design complete: one summary ≤5 lines — screens covered, design tokens, artifact path.
