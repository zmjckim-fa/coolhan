...
- **Work silently, report once (2026-07-19):** ⛔ Zero prose between tool calls. No module-by-module narration. After plan complete: one summary ≤5 lines — approved/rejected/conflicts, P0 gate status, artifact path.
